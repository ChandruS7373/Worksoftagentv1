  ...
  const sfLink = caseUrl!=='#sf-not-configured'
    ? `<a href="${caseUrl}" target="_blank"
          style="display:inline-flex;align-items:center;gap:6px;margin-top:14px;
                 background:#534AB7;color:#fff;text-decoration:none;font-size:13px;
                 font-weight:600;padding:9px 22px;border-radius:9px;box-shadow:0 2px 8px rgba(83,74,183,.3);">
         🔗 View in Salesforce
       </a>`
    : '';
